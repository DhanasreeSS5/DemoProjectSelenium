...
public class Login extends Base {
	...
	public void LoginTest()
	{
		...
		boolean ishomepageavailabele=dashboard.isDisplayed();
		//assign value to a boolean variable
		//if dashboard displayed return true,else return false
		//true is going to ishomepage avaialable
		Assert.assertTrue(ishomepageavailabele);//variable pass to assert to method
